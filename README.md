...
### Gereksinimler
- [Node.js](https://nodejs.org/) (v16.9.0 veya üstü)
- [Discord Developer Portal](https://discord.com/developers/applications) üzerinden alınmış bir bot token'ı
...
2. **Bağımlılıkları Yükleyin**
   Gerekli Node.js paketlerini yüklemek için:
   ```bash
   npm install discord.js
   ```
...
3. **Botu Yapılandırın**
   ...
   - Yer tutucu değerleri kendi değerlerinizle değiştirin:
     ```javascript
     const config = {
         token: 'BOT_TOKENINIZ',
         guildId: 'SUNUCU_ID',
